package com.yh.sourceget.core.engine.http;
...
import com.yh.sourceget.core.engine.util.ApiClientConfiguration;
import com.yh.sourceget.core.engine.util.Util;
...
public class ApiRequest {
    ...
    public ApiRequest(EBodyFormat format) {
    	headers = new HashMap<String, String>();
    	params = new HashMap<String, String>();
    	body = new HashMap<String, Object>();
    	httpMethod = HttpMethodName.POST;
    ...
    public ApiRequest(HashMap<String, String> header, HashMap<String, String> bodyParams) {
        headers = header;
        params = bodyParams;
    }
    ...
    public ApiClientConfiguration getConfig() {
        return config;
    }

    public void setConfig(ApiClientConfiguration config) {
        this.config = config;
    }
}
